    ...
    <section className="bg-white px-4 py-12 md:px-10 lg:px-20">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-8">
          ...
          <div className="h-0.5 mx-auto mb-12 bg-gradient-to-r from-[#0097b2] to-[#7ed952] mt-4 rounded-full w-1/2 md:w-1/3" />
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10">
          ...
          {/* Right: Text */}
          <div className="w-full lg:w-1/2 text-justify text-gray-700 text-[1rem] leading-relaxed flex flex-col justify-between">
            <div>
              <p className="mb-1">
